...
number_of_quarter = int(input('Введите номер четверти (1-4): '))

if number_of_quarter == 1:
    print ('Х изменяется от 0 до +бесконечности, Y изменяется от 0 до +бесконечности')
    ...
    print ('Вы ввели неверную цифру. Всего существует 4 четверти')
